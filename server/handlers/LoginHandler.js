                ...
                .then(function(heroes) {
                    ...
                    return data.item.findItemsByKeys(itemIds)
                        .then(function(items) {
                            ...
                            // spawn items based on their chance to spawn
